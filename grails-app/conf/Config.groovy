...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'tendoss.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'tendoss.UserRole'
grails.plugin.springsecurity.authority.className = 'tendoss.Role'
